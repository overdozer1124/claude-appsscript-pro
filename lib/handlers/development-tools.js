...
export class DevelopmentToolsHandler {
  ...
  getToolDefinitions() {
    return [
      ...
      },
      {
        ...
        description: 'Delete a file from an Apps Script project with dependency checking',
        inputSchema: {
          type: 'object',
          properties: {
            script_id: { 
            ...
            force: {
              type: 'boolean',
              description: 'Force deletion without dependency warnings (default: false)',
              default: false
            }
          },
          required: ['script_id', 'file_name']
      ...
      {
        name: 'search_files',
        description: 'Search for files and content within an Apps Script project',
        inputSchema: {
          type: 'object',
          properties: {
            script_id: { 
            ...
            search_type: {
              type: 'string',
              enum: ['file_name', 'content', 'both'],
              description: 'Type of search to perform (default: both)',
              default: 'both'
            },
            case_sensitive: {
              type: 'boolean',
   ...
   */
  canHandle(toolName) {
    return ['add_script_file', 'update_script_file', 'get_script_file_contents', 'delete_script_file', 'search_files'].includes(toolName);
  }
