...
if "!NODE_PATH!"=="" (
    ...
    echo ⚠️  Node.jsパスが見つかりません。デフォルトパスを使用: !NODE_PATH!
) else (
    echo ✅ Node.jsパス検出: !NODE_PATH!
)
