...
:: 先頭で必ずメインにジャンプ（サブルーチン誤実行による早期終了を防ぐ）
goto :MAIN
...
title Claude-AppsScript-Pro 完全自動インストーラー v%SCRIPT_VERSION%

echo(
echo(╔══════════════════════════════════════════════════════════════╗
echo(║                                                              ║
echo(║   Claude-AppsScript-Pro 完全自動インストーラー v%SCRIPT_VERSION%   ║
...
if not exist "install-windows.bat" (
    echo ❌ install-windows.bat が見つかりません
    echo [!DATE! !TIME!] 基本インストールファイル欠如 >> "!LOG_FILE!"
...
echo(╚══════════════════════════════════════════════════════════════╝
echo(
echo ✅ Claude-AppsScript-Pro v%SCRIPT_VERSION% 基本インストール完了
echo ⏱️  完了時刻: %TIME%
